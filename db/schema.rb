...
ActiveRecord::Schema.define(version: 20160317230054) do
  ...
  create_table "games", force: true do |t|
    ...
    t.string   "wind_1_value"
    t.string   "humidity_1_value"
    t.string   "pressure_1_value"
    t.string   "temperature_1_value"
    t.string   "precipitation_1_value"
    t.string   "wind_2_value"
    t.string   "humidity_2_value"
    t.string   "pressure_2_value"
    t.string   "temperature_2_value"
    t.string   "precipitation_2_value"
    t.string   "wind_3_value"
    t.string   "humidity_3_value"
    t.string   "pressure_3_value"
    t.string   "temperature_3_value"
    t.string   "precipitation_3_value"
  end
